...
$(function()
{
    ...
    $.getJSON(`http://localhost:8081/api/teams/${teamId}/members/${membId}`, function(data) {
      objs = data;
      postData(objs);
    });
    ...
    {
        $.ajax({
            url: `http://localhost:8081/api/teams/${teamId}/members/${membId}`,
            type: 'DELETE',
            success: function() {
    ...
    let backBtn = `<a class='btn btn-secondary ml-1 mt-4' id='cancelBtn' href=details.php?teamid=${teamId}>Back to Teams</a>`
